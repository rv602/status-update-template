...
(function(global, factory) {
    ...
    var DropdownUI = /** @class */ (function() {
        ...
        DropdownUI.prototype.show = function() {
            ...
            new Popper(this.$button, $dropdown, {
                placement: 'top-start',
                modifiers: {
                    offset: {
                        enabled: true,
    ...
    var dropdownCheck = renderer.create('<div class="note-dropdown-menu note-check" role="list">', function($node, options) {
        var markup = Array.isArray(options.items)
            ? options.items.map(function(item) {
                  ...
                  var content = options.template ? options.template(item) : item;
                  var $temp = $(
                      '<a class="note-dropdown-item" href="#" data-value="' + value + '" role="listitem" aria-label="' + item + '"></a>'
                  );
            ...
            children: [
                button({
                    ...
                    callback: function($button) {
                        ...
                        if (type !== 'foreColor') {
                            $recentColor.css('background-color', '#FFF');
                            $button.attr('data-backColor', '#FFF');
                        }
                    }
                }),
                button({
                ...
                dropdown({
                    items: [
                        ...
                        '  <div>',
                        '<button type="button" class="note-color-reset note-btn note-btn-block" ' +
                            ' data-event="foreColor" data-value="foreColor">',
        ...
        $node.html(
            [
                ...
                options.title
                    ...
                    '      <button type="button" class="close" aria-label="Close" aria-hidden="true"><i class="note-icon-close" data-tooltip="close"></i ></button > ' +
    ...
    var ui = {
        ...
        createLayout: function($note, options) {
            var $editor = (options.airMode
                ...
                : ui.editor([ui.editingArea([ui.codable(), ui.editable()]), ui.toolbar(), ui.statusbar()])
            ).render();
    ...
    var Editor = /** @class */ (function() {
        function Editor(context) {
            ...
            this.fontName = this.wrapCommand(function(value) {
                return _this.fontStyling('font-family', "'" + value + "','arial'");
            });
        ...
        Editor.prototype.fontStyling = function(target, value) {
            ...
            if (rng) {
                ...
                if (target !== 'font-family') {
                    $$1(spans).css('font-family', styleInfo['font-family']);
                }
                if (target !== 'font-size') {
                    $$1(spans).css('font-size', styleInfo['font-size']);
                }
    ...
    var Dropzone = /** @class */ (function() {
        function Dropzone(context) {
            ...
            this.$dropzone = $$1(['<div class="note-dropzone">', '  <div class="note-dropzone-message"/>', '</div>'].join('')).prependTo(
                this.$editor
            );
        }
        /**
                            ...
                            items:
                                ...
                                (foreColor
                                    ? [
                                          ...
                                          '  <div>',
                                          '    <button type="button" class="note-color-reset btn btn-light" data-event="foreColor" data-value="' +
        ...
        VideoDialog.prototype.createVideoNode = function(url) {
            ...
            if (ytMatch && ytMatch[1].length === 11) {
                ...
                $video = $$1('<iframe>')
                    ...
                    .attr(
                        'src',
                        'https://www.facebook.com/plugins/video.php?href=' + encodeURIComponent(fbMatch[0]) + '&show_text=0&width=560'
                    )
                    .attr('width', '560')
                    .attr('height', '301')
                    .attr('scrolling', 'no')
    ...
    $$1.summernote = $$1.extend($$1.summernote, {
        ...
        options: {
            ...
            fontSizes: ['8', '9', '10', '11', '12', '13', '14', '16', '18', '22', '24', '36'],
